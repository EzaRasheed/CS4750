...
<select name="size_choice" class="browser-default custom-select bg-secondary" style="color: white;">
	  <option value="" disabled selected>Choose Size</option>
	  <option style="color: white;"value="XS"> XS </option>
	  <option style="color: white;"value="S"> S </option>
	  <option style="color: white;"value="M"> M </option>
	  <option style="color: white;"value="L">L </option>
	  <option style="color: white;"value="XL"> XL </option>
	  <option style="color: white;"value="XXL"> XXL </option>
</select>

<input class="btn btn-dark" type="submit" name="submit" value="Filter!">
...
<?php
  ...
  if(isset($_POST['submit'])){
    if(!empty($_POST['size_choice'])) {
        $selected = $_POST['size_choice'];
		$apparels = filterBySize($selected);  
    } 
    }
   else{
   ...
   if(isset($_POST['submit'])){
    if(!empty($_POST['article_choice'])) {
        $selected = $_POST['article_choice'];
		$apparels = filterByArticle($selected);  
    } 
    }
   else{
...
<br>
    <table class="table table-striped table-bordered">
      ...
      <tr>
        ...
        <td>
          <?php echo $a['material']; // refer to column name in the table ?> 
        </td>
        <td>
          <?php echo $a['theme']; ?> 
        </td>        
