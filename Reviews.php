...
if (!empty($_POST['db-btn']))
{
   ...
   {
   	  if (!empty($_POST['review_number']) && !empty($_POST['num_rating']) && !empty($_POST['text_comment']))
         addReview($_POST['review_number'], $_POST['num_rating'], $_POST['text_comment']);
	  else {
		  $msg = "Enter all Reviews's information to add this review!";
	  }
   }  
...
<div class="col-sm-10">
	...
	<form action="Reviews.php" method="post">  
		<div class="form-group">
		  ...
		  <input type="text" name="review_number" class="form-control" />        
	   </div>      
	   <div class="form-group">
		  <label for="num_rating">Rating</label>  
		  <input type="text" name="num_rating" class="form-control" />  
	   </div>      
	   <div class="form-group">
		  <label for="text_comment">Text Comment</label>  
		  <input type="textarea" name="text_comment" class="form-control"/>  
	   </div>    
	   ...
	   <div class="form-group">
		  <input type="submit" value="Insert" class="btn btn-dark" name="db-btn" title="Insert into 'Reviews' table" />
    ...
    <table class="table table-striped table-bordered">
      ...
      <tr>
		<td>
          <?php echo $r['review_number']; // refer to column name in the table ?> 
        </td>
		<td>
          <?php echo $r['num_rating']; // refer to column name in the table ?> 
        </td>
		<td>
          <?php echo $r['text_comment']; // refer to column name in the table ?> 
        </td>
